...
const Auth = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Log In or Sign Up - AMAA.pro"
        description="Create an account or log in to access AMAA.pro, your AI assistant for research, coding, and content generation."
        canonicalUrl="https://amaa.pro/auth"
      />
