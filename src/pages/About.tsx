...
import { getAppSchema, getOrganizationSchema } from '@/utils/schemaData';
...
const About = () => {
  ...
  return (
    <>
      <SEOHead 
        title="About AMAA.pro - AI Research Assistant for Professionals"
        description="AMAA.pro is your AI research assistant for coding, content creation, and file analysis. Learn about our mission, features, and the team behind this innovative tool."
        keywords="AI assistant, code analysis, content generation, AMAA.pro, Angelyze, research tool, file analysis"
        canonicalUrl="https://amaa.pro/about"
        schema={schema}
      />
            ...
            <div className="max-w-[800px] mx-auto">
              <div className="flex flex-col items-center text-center space-y-6">
                <div className="animate-float w-full flex justify-center">
                  <div style={{ width: '500px', minWidth: '500px' }}>
                    <img 
                      src="/AMAA.png" 
                      alt="AMAA.pro - AI Research Assistant" 
              ...
              <div className="mt-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="flex items-start gap-2 bg-foreground/5 p-3 rounded-lg border border-foreground/10">
                      <MessageSquare className="w-24 h-24 text-primary mt-1" />
                      <div>
                    ...
                    <div className="flex items-start gap-2 bg-foreground/5 p-3 rounded-lg border border-foreground/10">
                      <FileText className="w-24 h-24 text-primary mt-1" />
                      <div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-2 bg-foreground/5 p-3 rounded-lg border border-foreground/10">
                      <Star className="w-24 h-24 text-primary mt-1" />
                      <div>
                    ...
                    <div className="flex items-start gap-2 bg-foreground/5 p-3 rounded-lg border border-foreground/10">
                      <CircleCheck className="w-24 h-24 text-primary mt-1" />
                      <div>
              ...
              <div className="mt-20">
                ...
                <div className="flex items-center gap-6 mb-10">
                  <img src="/Angelyze.png" alt="Angelyze Logo" className="w-40 h-40 object-contain" />
