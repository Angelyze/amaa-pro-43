...
const Privacy = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Privacy Policy - Secure AI Assistant Platform"
        description="AMAA.pro is committed to protecting your privacy. Read our comprehensive privacy policy to learn how we handle your data."
        keywords="privacy policy, data protection, AMAA.pro privacy, AI assistant privacy, security"
        canonicalUrl="https://amaa.pro/privacy"
      />
