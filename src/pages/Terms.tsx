...
const Terms = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Terms of Service - AMAA.pro AI Assistant Platform"
        description="Read the terms of service for AMAA.pro, the AI assistant platform for research, coding, and content generation."
        keywords="AMAA.pro terms, terms of service, AI assistant terms, legal, privacy"
        canonicalUrl="https://amaa.pro/terms"
      />
