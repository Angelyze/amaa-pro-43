...
const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header 
      className={`header-container fixed top-0 left-0 right-0 z-[9999] bg-background/50 backdrop-blur-md border-b transition-all duration-300 ${visible ? 'translate-y-0 opacity-99' : '-translate-y-full opacity-0'}`}
    >
