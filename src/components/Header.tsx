...
const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header 
      className={`header-container fixed top-0 left-0 right-0 z-1000 bg-background/80 backdrop-blur-md border-b border-border transition-all duration-300 ${visible ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'}`}
    >
